...
<link rel="stylesheet" href="assets/css/styles.css?v=20260913-4">
<script type="application/ld+json">${JSON.stringify(allSchemas.length === 1 ? allSchemas[0] : allSchemas)}</script>
<script defer src="assets/js/i18n.js?v=20260913-4"></script>
<script defer src="assets/js/site.js?v=20260913-4"></script>
</head>
<body data-page="${page}">
